...
/**
 * Handler para listar Municipios.
 * 
 ...
 * - Controlador interactivo de consola. Intercepta la acción de ListMunicipios, solicita la entrada de datos al usuario de forma amigable, ensambla la petición y delega la ejecución al Controlador Principal.
 * 
 * Detalles del Componente:
 * - Nombre de Clase/Interface: ListMunicipiosHandler
 ...
 * ==========================================================================================
 */
public class ListMunicipiosHandler implements MunicipioOperationHandler {

    private final GetAllMunicipiosUseCase useCase;
    private final CensoConsoleIO console;

    @Override
    public void handle() {
        console.println("\n--- Listado de Municipios ---");
        List<MunicipioModel> models = useCase.execute();
        ...
        if (responses.isEmpty()) {
            console.println("No hay municipios registrados.");
        } else {
