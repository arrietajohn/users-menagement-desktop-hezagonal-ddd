...
/**
 * DTO para la creaciÃ³n de un Municipio desde la UI.
 * 
 ...
 * - Objeto de Transferencia de Datos (DTO) inmutable. Encapsula y transporta de forma segura los parámetros de entrada desde el exterior hacia los servicios de la aplicación para el proceso de CreateMunicipio.
 * 
 * Detalles del Componente:
 * - Nombre de Clase/Interface: CreateMunicipioRequest
