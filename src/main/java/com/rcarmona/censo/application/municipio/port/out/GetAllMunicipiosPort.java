...
/**
 * Puerto de Salida para listar todos los Municipios.
 * 
 ...
 * - Interfaz de salida (Out Port) que define el contrato de persistencia o comunicación externa para GetAllMunicipios. Garantiza el Principio de Inversión de Dependencias aislando la base de datos de la lógica central.
 * 
 * Detalles del Componente:
 * - Nombre de Clase/Interface: GetAllMunicipiosPort
 ...
 * ==========================================================================================
 */
public interface GetAllMunicipiosPort {
