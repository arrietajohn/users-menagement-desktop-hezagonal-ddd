...
/**
 * Puerto de Salida para buscar por provincia.
 * 
 ...
 * - Interfaz de salida (Out Port) que define el contrato de persistencia o comunicación externa para FindMunicipiosByProvincia. Garantiza el Principio de Inversión de Dependencias aislando la base de datos de la lógica central.
 * 
 * Detalles del Componente:
 * - Nombre de Clase/Interface: FindMunicipiosByProvinciaPort
 ...
 * ==========================================================================================
 */
public interface FindMunicipiosByProvinciaPort {
    List<MunicipioModel> findByProvinciaId(Integer provinciaId);
}
