...
/**
 * Puerto de Salida para buscar por nombre.
 * 
 ...
 * - Interfaz de salida (Out Port) que define el contrato de persistencia o comunicación externa para SearchMunicipiosByName. Garantiza el Principio de Inversión de Dependencias aislando la base de datos de la lógica central.
 * 
 * Detalles del Componente:
 * - Nombre de Clase/Interface: SearchMunicipiosByNamePort
 ...
 * ==========================================================================================
 */
public interface SearchMunicipiosByNamePort {
    List<MunicipioModel> searchByName(String partialName);
}
