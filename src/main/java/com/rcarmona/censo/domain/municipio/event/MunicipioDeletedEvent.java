 ...
 * - Evento de Dominio puro. Representa un suceso histórico inmutable (algo que ya pasó) relacionado con MunicipioDeleted. Facilita el desarrollo de una arquitectura orientada a eventos con muy bajo acoplamiento.
 * 
 * Detalles del Componente:
 * - Nombre de Clase/Interface: MunicipioDeletedEvent
 ...
 * ==========================================================================================
 */
public class MunicipioDeletedEvent extends DomainEvent {
    private final String municipioId;

    public MunicipioDeletedEvent(final String municipioId) {
        super();
