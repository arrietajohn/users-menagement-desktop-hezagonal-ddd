...
@Getter
public final class ResidenciaCreatedDomainEvent extends DomainEvent {

  private static final String EVENT_NAME = "residencia.created";

  private final ResidenciaModel residencia;

  public ResidenciaCreatedDomainEvent(final ResidenciaModel residencia) {
    super(EVENT_NAME);
