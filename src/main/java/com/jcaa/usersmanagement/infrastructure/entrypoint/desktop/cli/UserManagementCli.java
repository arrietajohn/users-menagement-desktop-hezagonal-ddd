...
public final class UserManagementCli {
  ...
  public void start() {
    ...
    runLoop(buildHandlers(printer, console));
  }
  ...
  private Map<MenuOption, OperationHandler> buildHandlers(
    ...
    return Map.of(
            ...
            // AEROLINEAS
            MenuOption.LIST_AEROLINEAS,
            new ListAerolineasHandler(aerolineaController, console),

            MenuOption.CREATE_AEROLINEA,
            new CreateAerolineaHandler(aerolineaController, console),

            MenuOption.DELETE_AEROLINEA,
            new DeleteAerolineaHandler(aerolineaController, console),
            // LOGIN
