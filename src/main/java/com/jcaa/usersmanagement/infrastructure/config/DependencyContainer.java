...
import com.jcaa.usersmanagement.application.service.CreateSucursalService;
import com.jcaa.usersmanagement.application.service.CreateUserService;
import com.jcaa.usersmanagement.application.service.DeleteSucursalService;
...
import com.jcaa.usersmanagement.application.service.UpdateSucursalService;
...
import com.jcaa.usersmanagement.infrastructure.adapter.persistence.repository.SucursalRepositoryMySQL;
...
public final class DependencyContainer {
    ...
    public DependencyContainer() {
        ...
        final SucursalRepositoryMySQL sucursalRepository = new SucursalRepositoryMySQL(connection);
        ...
        //  Casos de uso de Sucursal
        final CreateSucursalUseCase createSucursalUseCase =
                new CreateSucursalService(sucursalRepository, sucursalRepository, validator);
        final UpdateSucursalUseCase updateSucursalUseCase =
                new UpdateSucursalService(sucursalRepository, sucursalRepository, validator);
        final DeleteSucursalUseCase deleteSucursalUseCase =
                new DeleteSucursalService(sucursalRepository, sucursalRepository, validator);
