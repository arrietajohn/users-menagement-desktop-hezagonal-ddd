...
import com.jcaa.usersmanagement.infrastructure.adapter.persistence.repository.ClienteRepositoryMySQL;
...
public final class DependencyContainer {
  ...
  public DependencyContainer() {
    ...
    // Cliente
    final ClienteRepositoryMySQL clienteRepository = new ClienteRepositoryMySQL(connection);

    final CreateClienteUseCase createClienteUseCase = new CreateClienteService(clienteRepository);
    final UpdateClienteUseCase updateClienteUseCase = new UpdateClienteService(clienteRepository);
    final DeleteClienteUseCase deleteClienteUseCase = new DeleteClienteService(clienteRepository);
    final GetClienteByIdUseCase getClienteByIdUseCase = new GetClienteByIdService(clienteRepository);
