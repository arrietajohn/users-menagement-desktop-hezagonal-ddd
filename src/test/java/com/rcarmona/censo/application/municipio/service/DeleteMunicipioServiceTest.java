 ...
 * - Suite de pruebas unitarias (Testing). Valida automáticamente el comportamiento y las reglas de negocio de la clase DeleteMunicipioService, garantizando que no existan regresiones en el código mediante escenarios de éxito y fallo.
 * 
 * Detalles del Componente:
 * - Nombre de Clase/Interface: DeleteMunicipioServiceTest
 ...
 * ==========================================================================================
 */
class DeleteMunicipioServiceTest {

    @Mock
    private DeleteMunicipioPort deleteMunicipioPort;

    @Mock
    private GetMunicipioByIdPort getMunicipioByIdPort;

    @InjectMocks
    private DeleteMunicipioService service;

    @Test
    void execute_WhenExists_Deletes() {
        ...
        assertDoesNotThrow(() -> service.execute(new DeleteMunicipioCommand(1)));
        verify(deleteMunicipioPort).delete(any(MunicipioId.class));
    }
    ...
    void execute_WhenNotExists_ThrowsException() {
        ...
        assertThrows(MunicipioNotFoundException.class, () -> service.execute(new DeleteMunicipioCommand(99)));
        verify(deleteMunicipioPort, never()).delete(any());
    }
}
